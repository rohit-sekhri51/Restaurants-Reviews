...
pub fn update_review(
    ...
    let mut account_data =
        try_from_slice_unchecked::<AccountState>(&pda_account.data.borrow()).unwrap();
    msg!(
        "Borrowed Account Data. Zomato Review title: {}",
        account_data.title
    );
    ...
    msg!("Zomato Review #before# update:");
    ...
    msg!("Zomato Review #after# update:");
    msg!("Title: {}", account_data.title);
    msg!("Rating: {}", account_data.rating);
    msg!("Description: {}", account_data.description);
    msg!("Location: {}", account_data.location);
